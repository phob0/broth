...
class UserController extends EditableController
{
    ...
    public function list(UserRepository $userRepository, Request $request)
    {
        ...
        $this->authorize('viewAny', [User::class, $params['target_type'] ?? '', $params['target_id'] ?? 0]);
    ...
    public function create(Request $request, UserRepository $userRepository)
    {
        ...
        $this->authorize('create', [User::class, $targetType, $targetId]);
    ...
    public function destroy(UserRepository $userRepository, User $user)
    {
