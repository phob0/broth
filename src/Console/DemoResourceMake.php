...
class DemoResourceMake extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'broth:demoResource';
    ...
    {
        return  $this->argument('name') === 'User' ? $this->resolveStubPath('/stubs/demo/userResourceDemo.stub') : $this->resolveStubPath('/stubs/demo/settingResourceDemo.stub');
    }
